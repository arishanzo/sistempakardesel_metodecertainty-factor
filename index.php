            ...
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-lg-6 py-3 wow fadeInUp">
                        <h1 class="title-section">Ketahui jenis <span class="marked"> Kerusakan </span> diesel anda</h1>
                        <p class="text-lg mb-5">Desel Salah Satu Alat Penting Buat Tani</p>

                        <a href="web/konsultasi.php" class="btn btn-outline border text-secondary">Diagnosa Sekarang</a>
                        <a href="web/about.php" class="btn btn-primary btn-split ml-2">About <div class="fab"><span class=""></span></div></a>
                    </div>
