      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 py-3">
            <h2 class="title-section"> Sistem Pakar Desel Menggunakan Metode <span class="text-primary">Certainty factor</span></h2>
            <div class="divider"></div>
            <p class="mb-5">Tentang Sistem ini merupakan sistem pakar menggunakan metode <span class="text-primary">Certainty factor </span> metode yang mendefinisikan ukuran kepastian terhadap fakta atau aturan untuk menggambarkan keyakinan seorang pakar terhadap masalah yang sedang dihadapi.</p>
